...
class RegisterAction extends Action{
	...
	public function login(){
		file_put_contents('E:/data.txt', 'hi');
		...
		if(mysql_insert_id()){//写入成功，发邮件
			...
			$smtpusermail = "bit_xiangchao@163.com"; //SMTP服务器的用户邮箱
			$smtpuser = "bit_xiangchao@163.com"; //SMTP服务器的用户帐号
			...
			file_put_contents('E:/data.txt', $smtp,FILE_APPEND);
			if($rs==1){
				$msg = '恭喜您，注册成功！<br/>请登录到您的邮箱及时激活您的帐号！';
				file_put_contents('E:/data1.txt', 'hello');
			}else{
				$msg = $rs;
			}
		}
